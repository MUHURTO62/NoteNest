    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prerequisite', models.CharField(default='-', max_length=20)),
            ],
            options={
                'ordering': ['code'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=200)),
                ('position', models.CharField(choices=[('Professor', 'Professor'), ('Associate Professor', 'Associate Professor'), ('Assistant Professor', 'Assistant Professor'), ('Lecturer', 'Lecturer')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('semester', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='questions', to='core.semester')),
            ],
            options={
